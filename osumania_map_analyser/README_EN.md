# osu!mania Map Analyser

**English | [中文](README.md)**

osu!mania Map Analyser is an in-game overlay (ppcounter) for [tosu](https://tosu.app). It provides real-time difficulty estimation, RC/LN pattern analysis, configurable Etterna MSD calculation, difficulty graphs, and pause detection for osu!mania 4K, 6K, and 7K on stable and lazer with multiple Mods.
